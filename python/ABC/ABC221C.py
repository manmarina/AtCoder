...
分離の仕方は最大で 9!x8=2903040 通りだけど、
bit全探索は順列を無視するので（2⁹ = 512通り）。
得られた数列は降順にソート（積を最大化したい）してからかけ合わせるので、順列を無視したほうが効率が良い。

https://atcoder.jp/contests/abc221/tasks/abc221_c
https://chatgpt.com/c/68d0f864-dc6c-8331-aad2-5f5a9841f634
"""
